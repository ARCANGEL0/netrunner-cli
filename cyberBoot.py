...
#
    ...
    while keyInput != novaLinha:
        ...
        if keyInput == ord('\n') and selection == 0:
                ...
                thread.start()
               audio("$HOME/.boot/audio/goBack.mp3")
            ...
            thread.start()
            if checkPS('fusuma'):
               audio("$HOME/.boot/audio/fusumaOff.mp3")
                print("\n\nフスマを停車ている")
                time.sleep(2)
               ...
               audio("$HOME/.boot/audio/fusumaOn.mp3")
                print("\n\nフスマを始めている")
                time.sleep(2)
                os.system('fusuma -d')
                scr.erase()
            ...
            thread.start()
            if checkPS('apache'):
               audio("$HOME/.boot/audio/apacheOff.mp3")
                print("\n\nアパッチを停車ている")
                time.sleep(2)
               ...
               audio("$HOME/.boot/audio/apacheOn.mp3")
                print("\n\nアパッチを始ている")
                time.sleep(2)
           ...
           audio("$HOME/.boot/audio/keyenter.wav")
            ...
            if checkPS('mariadb'):
               audio("$HOME/.boot/audio/sqlOff.mp3")
                print("\n\nデータベースを停車ている")
                time.sleep(2)
               ...
               audio("$HOME/.boot/audio/sqlOn.mp3")
                print("\n\nデータベースを始ている")
                time.sleep(2)
            ...
            thread.start()
            if checkPS('snapd'):
               audio("$HOME/.boot/audio/snapOff.mp3")
                print("\n\nスナップを停車ている")
                time.sleep(2)
               ...
               audio("$HOME/.boot/audio/snapOn.mp3")
                print("\n\nスナップを始ている")
                time.sleep(2)
                os.system(
           ...
           audio("$HOME/.boot/audio/keyenter.wav")
            ...
            if checkPS('bluetoothd'):
               audio("$HOME/.boot/audio/bluetoothOff.mp3")
               ...
               audio("$HOME/.boot/audio/bluetoothOn.mp3")
                print("\n\nブルートゥースを始ている")
                time.sleep(2)
            ...
            thread = Thread(target=playKey)
            thread.start()
           audio("$HOME/.boot/audio/torOn.mp3")
            print("\n\n匿名ネットワークリレーを始めている")
            time.sleep(2)
            ...
            thread = Thread(target=playKey)
            thread.start()
           audio("$HOME/.boot/audio/torOff.mp3")
            print("\n\n匿名ネットワークリレーを停車ている")
            time.sleep(2)
...
def criarMenu(scr):
    ...
    while keyInput != novaLinha:
        ...
        if keyInput == ord('\n') and selection == 0:
            ...
            thread.start()
            print("\n\n\nTTYの端末を入るている")
           audio("$HOME/.boot/audio/EnterTerminal.mp3")
           ...
           audio("$HOME/.boot/audio/logs.mp3")
            ...
            thread = Thread(target=playKey)
            thread.start()
           audio("$HOME/.boot/audio/options.mp3")
            ...
            thread = Thread(target=playKey)
            thread.start()
           audio("$HOME/.boot/audio/logout.mp3")
            print("\n\n\nセッションを離れている")
            time.sleep(3)
            pid = os.getppid()
            os.kill(pid, 9)
            ...
            thread.start()
            print("\n\n\nシャットダウン。。。")
           audio("$HOME/.boot/audio/shutdown.mp3")
